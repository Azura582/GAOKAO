...
def export_union_json(directory: str, model_name: str, keyword: str, zero_shot_prompt_text: str | List[str], question_type: str) -> None:
    """
...
def export_distribute_json(
        ...
        directory: str, 
        keyword: str, 
        zero_shot_prompt_text: str | List[str], 
        question_type: str, 
        parallel_num: int = 5
    ) -> None:
    """
